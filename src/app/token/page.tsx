...
import { type TokenInfo, mockSolana } from '@/lib/solana/mockSolana';
...
export default function TokenPage() {
  ...
  const handleCreateToken = async () => {
    if (!formData.name || !formData.symbol) {
      alert('Molimo unesite ime i simbol tokena');
      return;
    }
    ...
    try {
      const token = await mockSolana.createToken(
        formData.name,
        formData.symbol,
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        >
          <p className='text-yellow-200 text-sm text-center'>
            🧪 Demo Mode: Ovo je simulacija. Stvarni token će biti kreiran na
          ...
          >
            ...
            <div className='bg-gray-900/50 rounded-xl p-6 space-y-4 mb-6'>
              ...
              <div>
                ...
                <p className='text-white font-semibold text-lg'>
                  {createdToken.supply.toLocaleString()} {createdToken.symbol}
                </p>
              </div>
            </div>
